...
function Buttons({filteredClothes, allClothes, data, setClothes}) {
    ...
    <div className="cont">
        ...
        <div className="cont">
            <form>
            <label>DRESS
            <input onClick={addItem} type="radio" name="dress" value='dress' checked={checked} onChange={() => setChecked(!checked)}/>
            </label>

            <label>SHOES
            <input onClick={addItem} type="radio" name="shoes" value='shoes' checked={checked} onChange={() => setChecked(!checked)}/>
            </label>
